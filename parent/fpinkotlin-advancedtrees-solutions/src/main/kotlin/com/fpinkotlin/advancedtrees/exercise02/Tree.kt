 ...
 *
 * 원저자 소스코드에서 internal로 되어있던 가시성을 protected 로 변경했음.
 *
 */
sealed class Tree<out A: Comparable<@UnsafeVariance A>> {
    ...
    protected abstract val isB: Boolean
    protected abstract val isBB: Boolean
    protected abstract val isTB: Boolean
    protected abstract val isTR: Boolean
    protected abstract val isTNB: Boolean

    protected abstract val right: Tree<A>
    protected abstract val left: Tree<A>
    protected abstract val value: A
    ...
    protected abstract fun redder(): Tree<A>

    protected abstract fun add(element: @UnsafeVariance A): Tree<A>
    ...
    protected abstract fun delete(element: @UnsafeVariance A): Tree<A>
